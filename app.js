...
function initializeSettings(){
    ...
    form.addEventListener(
        ...
        function(e){
            ...
            SentinelLink.settings.theme=

            $("#theme")?.value ||

            "dark";

            SentinelLink.settings.language=

            $("#language")?.value ||

            "English";

            SentinelLink.settings.notifications=
...
window.importReports=importReports;
